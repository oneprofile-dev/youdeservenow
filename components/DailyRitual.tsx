...
export default function DailyRitual({ highlightProduct }: DailyRitualProps) {
  return (
    <section className="max-w-5xl mx-auto px-4 sm:px-6 mt-14 mb-14">
        ...
        <div className="rounded-[2rem] bg-[var(--color-card-bg)] dark:bg-[var(--color-dark-surface)] border border-[var(--color-card-border)] dark:border-[var(--color-dark-border)] p-8 shadow-[0_24px_60px_rgba(0,0,0,0.05)]">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
            <a
              ...
              className="inline-flex items-center justify-center rounded-2xl bg-[var(--color-cta-bg)] dark:bg-[var(--color-accent)] text-[var(--color-cta-text)] dark:text-[var(--color-dark-bg)] px-6 py-3 font-semibold text-sm hover:opacity-90 active:scale-95 transition-all"
            >
